...
```{r}
write.csv(g, here("exercise", "Lecture-02", "exercise", "data", "data.csv"), 
          quote=FALSE, row.names=FALSE)
```
...
もしくは
```{r}
dat1 <- read.csv(here("exercise", "Lecture-02", "exercise", "data", "data.csv"), header = TRUE) 
```
...
もしくは
```{r}
dat2 <- readr::read_csv(here("exercise", "Lecture-02", "exercise", "data", "data.csv"))
```
...
もしくは
```{r}
dat3 <- data.table::fread(here("exercise", "Lecture-02", "exercise", "data", "data.csv"),
                          data.table = FALSE)
```
